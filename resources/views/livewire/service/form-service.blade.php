        ...
        <div class="flex flex-row flex-wrap items-end w-full  md:w-2/5">
            ...
            <div class="w-2/5 p-2">
                ...
                <div class="relative">
                    ...
                    <input type="time" name="service_time" id="service_time" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
            </div>
        </div>
