...
@section('content')
    <div class="grid gap-4">
        @if (session('status'))
            <div wire:transition.out class="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
