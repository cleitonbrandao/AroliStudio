...
FilamentUser, MustVerifyEmail, HasAppAuthentication,
HasAppAuthenticationRecovery, HasEmailAuthentication, HasTenants
{
    ...
    {
        return $this->belongsToMany(related: Team::class, table: 'members');
    }
