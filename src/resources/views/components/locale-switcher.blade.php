@php
    ...
    $availableLocales = [
        'pt_BR' => [
            'flag' => '🇧🇷',
            'name' => __('app.locale_pt_BR') ?? 'Português (Brasil)',
            'currency' => 'BRL'
        ],
        'en' => [
            'flag' => '🇺🇸',
            'name' => __('app.locale_en') ?? 'English (US)',
            'currency' => 'USD'
        ],
        'es' => [
            'flag' => '🇪🇸',
            'name' => __('app.locale_es') ?? 'Español',
            'currency' => 'EUR'
        ],
        'de' => [
            'flag' => '🇩🇪',
            'name' => __('app.locale_de') ?? 'Deutsch',
            'currency' => 'EUR'
        ],
    ];
@endphp
...
<div 
    class="relative inline-block text-left ms-3" 
    x-data="{ open: false }"
>
    <!-- Minimalist Button -->
    <button 
        ...
        title="{{ __('app.language_currency') }}"
    >
